...
- [x] Distributable macOS release packaging (`XPI.app`, `XPadInput-0.0.01.dmg`, `XPadInput-0.0.02.dmg`, `XPadInput-0.0.03.dmg`, `XPadInput-0.0.04.dmg`, and ZIPs with SHA-256 validation).
...
| Release packaging | Q1 2026 | ✅ Complete | Alpha 0.0.01, 0.0.02, 0.0.03 & 0.0.04 DMG/ZIP + SHA-256 |
